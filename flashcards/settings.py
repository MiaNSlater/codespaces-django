...
SECRET_KEY = config("SECRET_KEY", default='ey3n2o2kn5i6m495n65o3n2i2a6m7onqn1kz')
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "flashcards" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATIC_URL = "static/"
STATIC_ROOT = BASE_DIR / "flashcards" / "staticfiles"
